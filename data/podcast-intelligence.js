window.GAGANAI_PODCASTS = {
  ...
  "lens": [
    {
      "label": "Core claim",
      "detail": "What is the guest actually arguing, stripped of showmanship?"
    },
    {
      "label": "Counterclaim",
      "detail": "What would a serious skeptic say, and does the episode address it?"
    },
    {
      "label": "Transcript evidence",
      "detail": "Which section, timestamp, or show-note segment supports the claim?"
    },
    {
      "label": "Governance implication",
      "detail": "What changes for risk, controls, accountability, data, or human oversight?"
    },
    {
      "label": "Enterprise action",
      "detail": "What should a bank, platform team, or executive do differently?"
    },
    {
      "label": "Timeline link",
      "detail": "Which radar signal does this conversation explain, confirm, or contradict?"
    }
  ],
  "shows": [
    {
